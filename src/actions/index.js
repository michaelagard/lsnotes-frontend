...
export const fetchNotes = () => {
  return dispatch => {
    ...
    axios
      ...
      .get('http://localhost:7100/api/notes')
      .then(response => {
...
export const fetchNote = id => {
  return dispatch => {
    ...
    axios
      ...
      .get(`http://localhost:7100/api/notes/${id}`)
      .then(response => {
...
export const addNote = note => {
  return dispatch => {
    ...
    axios
      ...
      .post('http://localhost:7100/api/notes/create', note)
...
export const deleteNote = id => {
  return dispatch => {
    ...
    axios
      ...
      .delete(`http://localhost:7100/api/notes/delete/${id}`)
      .then(response => {
        // console.log(response.data);
...
export const editNote = (id, note) => {
  return dispatch => {
    ...
    axios
      ...
      .put(`http://localhost:7100/api/notes/edit/${id}`, note)
